...
const ryskUrl = new URLMesh({ mediaurl: "video_url", dataurl: "data_url" });
...
```
Tested version of three.js compatible with ``@mantisvision/rysk`` is r180. If you use a different version, there might be issues due to frequent changes in three.js API.
